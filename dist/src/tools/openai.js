...
exports.openaiTool = exports.OpenAITool = void 0;
...
class OpenAITool {
    ...
    async isConfigured() {
        try {
            const credential = await memory_db_1.memoryDB.findActiveToolCredential('openai');
            if (!credential) {
                return false;
            }
    ...
    async chat(params) {
        ...
        try {
            const response = await axios_1.default.post(`${this.baseUrl}/chat/completions`, chatParams, {
                headers: {
...
exports.OpenAITool = OpenAITool;
exports.openaiTool = new OpenAITool();
