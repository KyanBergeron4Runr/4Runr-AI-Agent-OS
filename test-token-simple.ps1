...
Write-Host "Simple token generation test..." -ForegroundColor Green
...
# Generate token with simple date format
...
try {
    ...
    Write-Host "The system is partially working but token generation needs fixing." -ForegroundColor Yellow
}
